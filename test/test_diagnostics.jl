@testset "diagnostics" begin
    ...
    task = Detangle.@task "t1" begin
        Detangle.@access obj Write() Block(1:2)
        obj[][1] = 2
    end
    ...
    other_task = Detangle.@task "t2" begin
        Detangle.@access obj Read() Block(2:3)
    end
